...
/** Render body — handles both HTML (from /api/generate-blog) and Markdown (from /api/generate-blog-post). */
function renderBody(body: string): React.ReactNode {
  // HTML content generated by the new route
  ...
  // Markdown-style content from the existing route
  ...
  for (const line of lines) {
    if (line.startsWith("## ")) {
      elements.push(
        <h2 key={key++} className="text-xl font-bold mt-8 mb-3" style={{ color: "#0F172A" }}>
          {line.slice(3)}
        </h2>
      );
