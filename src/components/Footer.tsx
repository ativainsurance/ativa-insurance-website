      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          <div>
            ...
            <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.65)", marginBottom: "16px" }}>{t("footer.tagline")}</p>
            <a href="https://wa.me/13213448474" target="_blank" rel="noopener noreferrer" aria-label="Contact via WhatsApp"
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl font-semibold text-white"
              style={{ fontSize: "15px", backgroundColor: "#25D366" }}>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a href="tel:5619468261" className="flex items-center gap-2 hover:text-white transition-colors duration-150"
                style={{ color: "rgba(255,255,255,0.80)", fontSize: "15px" }}>
                <svg viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4 shrink-0">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
                {t("footer.phone")}
              </a>
              <div className="flex items-start gap-2" style={{ color: "rgba(255,255,255,0.80)", fontSize: "14px" }}>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-2">
              <a href="/rce-calculator" className="hover:text-white transition-colors duration-150" style={{ color: "rgba(255,255,255,0.65)", fontSize: "15px" }}>{t("footer.links.rce")}</a>
              <a href="/blog"           className="hover:text-white transition-colors duration-150" style={{ color: "rgba(255,255,255,0.65)", fontSize: "15px" }}>{t("footer.links.blog")}</a>
            </div>
          </div>
        </div>
        {/* ── Social links ── */}
        ...
        <div className="pt-0 border-t-0">
          ...
          {/* Disclaimer */}
          <p style={{ fontSize: "13px", lineHeight: 1.65, color: "rgba(255,255,255,0.40)" }}>
            {t("footer.disclaimer")}
          </p>
        </div>
      </div>
