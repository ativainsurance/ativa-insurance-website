...
export default function Header({ mode }: HeaderProps) {
  ...
  return (
    <>
      ...
      >
        {/* Responsive container: shorter on mobile (h-16 = 64px), taller on desktop (h-28 = 112px) */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 md:h-28 flex items-center justify-between gap-4">

          {/* ── Logo ──────────────────────────────────────────────────────── */}
          <Link href="/?tab=personal" className="flex items-center shrink-0">
            <Image
              key={mode}
              src={logoSrc}
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/faq" className="px-3 py-2 rounded-lg hover:bg-black/5 transition-colors duration-150" style={navLinkStyle}>
              {t("nav.faq")}
            </Link>

            <Link href="/blog" className="px-3 py-2 rounded-lg hover:bg-black/5 transition-colors duration-150" style={navLinkStyle}>
              {t("nav.blog")}
            </Link>

            <a href="tel:5619468261" className="px-3 py-2 rounded-lg hover:bg-black/5 transition-colors duration-150 flex items-center gap-1.5" style={navLinkStyle}>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="hidden md:flex items-center" style={{ gap: "12px", marginRight: "4px" }}>
              <a href="https://www.facebook.com/ativainsurance/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"
              ...
              <a href="https://www.instagram.com/ativainsurance" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                style={{ color: "#64748B", transition: "color 200ms ease, transform 200ms ease", display: "flex" }}
                onMouseEnter={(e) => { const el = e.currentTarget as HTMLAnchorElement; el.style.color = "#F5A623"; el.style.transform = "translateY(-2px)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget as HTMLAnchorElement; el.style.color = "#64748B"; el.style.transform = "translateY(0)"; }}
              >
              ...
              <a href="https://maps.app.goo.gl/Zd8AptfZe46v9ntj8" target="_blank" rel="noopener noreferrer" aria-label="Google Reviews"
                style={{ color: "#64748B", transition: "color 200ms ease, transform 200ms ease", display: "flex" }}
                onMouseEnter={(e) => { const el = e.currentTarget as HTMLAnchorElement; el.style.color = "#F5A623"; el.style.transform = "translateY(-2px)"; }}
                onMouseLeave={(e) => { const el = e.currentTarget as HTMLAnchorElement; el.style.color = "#64748B"; el.style.transform = "translateY(0)"; }}
              >
            ...
            {/* Language switcher — desktop only; also rendered inside mobile menu */}
            <div
      ...
      {menuOpen && (
        ...
        >
          ...
          >
            <Link href="/?tab=personal" onClick={() => setMenuOpen(false)} className="flex items-center">
              <Image
                src={logoSrc}
                alt="Ativa Insurance"
                width={120}
            ...
            <button
              ...
              style={{ backgroundColor: "#F1F5F9", color: "#0F2A44" }}
            >
          ...
          <div className="flex-1 overflow-y-auto px-4 py-3">
            ...
            <Link
              ...
              style={{
                ...
                backgroundColor: isPersonal ? "#F8FAFF" : "transparent",
              }}
            >
              <span>Home</span>
              {isPersonal && (
            ...
            <Link
              ...
              style={{
                fontWeight: !isPersonal ? 700 : 500,
                backgroundColor: !isPersonal ? "#FFFBF0" : "transparent",
              }}
            >
            ...
            >
              ...
              >
                <svg viewBox="0 0 20 20" fill={accentColor} className="w-4 h-4">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/>
                </svg>
              </span>
              <div>
            ...
            <div className="flex items-center justify-center gap-1 mb-5">
              ...
              {LANGS.map(({ code, label }) => (
                <button
                  ...
                  style={
                    lang === code
                      ? { backgroundColor: "#F5A623", color: "#0B1F33" }
